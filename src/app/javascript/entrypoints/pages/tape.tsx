...
const element = () => {
  ...
  return <div class="grid w-full">
    <div class="relative">
      ...
      <div class="absolute left-[700px] top-[180px]">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 absolute left-[140px] top-[140px]">
          <Show when={volume() === 0}>
        ...
        <input type="range" min="0" max="100" value={volume()} oninput={(event) => setVolume(parseInt(event.target.value))} class="absolute range w-[19rem] -rotate-90 top-[-30px]" />
      </div>
    </div>
